...
def transfer_FCN_Vgg16():
    ...
    # Block 1
    conv1_1 = Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv1')(img_input)
    conv1_2 = Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv2')(conv1_1)
    pool1 = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='block1_pool')(conv1_2)
    ...
    pool2 = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='block2_pool')(conv2_2)
    ...
    pool3 = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='block3_pool')(conv3_3)
    ...
    pool4 = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='block4_pool')(conv4_3)
